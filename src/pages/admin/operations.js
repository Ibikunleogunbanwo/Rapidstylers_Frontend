...
const Operations = () => {
  ...
  return <div className="min-h-screen bg-[#f5f5f5] px-4 py-10"><div className="mx-auto max-w-5xl">    <div className="mb-6 flex items-center justify-between"><p className="text-2xl font-bold text-gray-900">Admin operations</p><button type="button" onClick={() => { clearAllSessionTokens(); window.location.href = "/admin/login"; }} className="text-sm font-semibold text-gray-500">Sign out</button></div><AdminNav />
